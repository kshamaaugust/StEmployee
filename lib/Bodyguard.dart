...
class BodyguardPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _gaurdState();
}
class _gaurdState extends State<BodyguardPage>{
  var id, token;
  var jsonData, total;
  ...
  Future<void> getData() async{   
    ...
    jsonData = null;
    var response = await http.get("http://139.59.66.2:9000/stapi/v1/users/?service=Professional&profession=Bodyguard&referedby="+id, headers: <String, String>{'authorization':token});    
  ...
  Widget build(BuildContext context) {  
    return new Scaffold(
      appBar: AppBar(
        title: Text('Bodygaurd', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {  
          Navigator.push(  
            context,  
            MaterialPageRoute(builder: (context) => AddGuardPage()),  
          );  
        },
...
class AddGuardPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _addguardState();
}
class _addguardState extends State<AddGuardPage>{
  var id;
  String myActivity;
  ...
  Widget build(BuildContext context) {  
    return new Scaffold(
      appBar: AppBar(
        title: Text('Bodyguard', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
      ),
      body: Center(
        child: ListView(
          children: <Widget>[
