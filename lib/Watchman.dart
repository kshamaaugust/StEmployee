...
class WatchmanPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _watchmanState();
}
class _watchmanState extends State<WatchmanPage>{
  var id, token;
  var jsonData, total;
  ...
  Future<void> getData() async{   
    ...
    jsonData = null;
    var response = await http.get("http://139.59.66.2:9000/stapi/v1/users/?service=Professional&profession=Watchman&referedby="+id, headers: <String, String>{'authorization':token});    
  ...
  Widget build(BuildContext context) {  
    return new Scaffold(
      appBar: AppBar(
        title: Text('Watchman', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {  
          Navigator.push(  
            context,  
            MaterialPageRoute(builder: (context) => AddWatchmanPage()),  
          );  
        },
...
class AddWatchmanPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _addwatchState();
}
class _addwatchState extends State<AddWatchmanPage>{
  var id;
  String myActivity;
