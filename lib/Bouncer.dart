...
class BouncerPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _bouncerState();
}
class _bouncerState extends State<BouncerPage>{
  var id, token;
  var jsondata, total;
  ...
  Future<void> getData() async{   
    ...
    jsondata = null;
    var response = await http.get("http://139.59.66.2:9000/stapi/v1/users/?service=Professional&profession=Bouncer&referedby="+id, headers: <String, String>{'authorization':token});    
  ...
  Widget build(BuildContext context) {  
    return new Scaffold(
      appBar: AppBar(
        title: Text('Bouncer', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {  
          Navigator.push(  
            context,  
            MaterialPageRoute(builder: (context) => AddBouncerPage()),  
          );  
        },
...
class AddBouncerPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _addBouncerState();
}
class _addBouncerState extends State<AddBouncerPage>{
  var id;
