...
class _ValetState extends State<ValetPage>{
  var id, token;
  var jsonData, total;
  ...
  Future<void> getData() async{  
    ...
    jsonData = null;
    var response = await http.get("http://139.59.66.2:9000/stapi/v1/users/?service=Professional&profession=Valet&referedby= "+id, headers: <String, String>{'authorization':token});    
  ...
  Widget build(BuildContext context) {  
    return new Scaffold(
      appBar: AppBar(
        title: Text('Valet', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {  
          Navigator.push(  
            context,  
            MaterialPageRoute(builder: (context) => AddValetPage()),  
          );  
        },
...
class AddValetPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _addvaletState();
}
class _addvaletState extends State<AddValetPage>{
  var id;
  String myActivity;
